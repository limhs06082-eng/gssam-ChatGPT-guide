...
const names = {choose:'도구 선택',setup:'시작 준비',prompt:'요청과 후속 질문',privacy:'자료와 개인정보',chat:'ChatGPT 채팅',files:'파일 질문',search:'검색과 출처',projects:'프로젝트 활용',work:'ChatGPT Work',compare:'비교와 분석',documents:'문서와 발표자료',review:'원본 대조와 검토',codex:'Codex',plan:'만들기 전 기획',debug:'오류 재현과 해결',publish:'인터넷 공개'};
...
const keys = [...foundationKeys,'chat',...chatPracticeKeys,'work',...workPracticeKeys,'codex',...codexPracticeKeys];
const publishedByGroup = {start:foundationKeys,chat:{0:'chat',3:'files',5:'search',6:'projects'},work:{0:'work',3:'compare',4:'documents',6:'review'},codex:{0:'codex',3:'plan',6:'debug',9:'publish'}};
...
const faqItems = [
 ...
 {id:'progress',group:'이 가이드 이용하기',question:'완료 표시와 이어보기는 어디에 저장되나요?',answer:'이 가이드를 여는 현재 브라우저에 저장됩니다. 회원가입이나 서버 전송은 없습니다. 다른 기기·브라우저에서는 이어지지 않으며, 브라우저 데이터를 지우면 초기화될 수 있습니다. 공통 입문 4편, 대표 실습 3편, 채팅·Work·Codex 실전 각 3편, 총 16편에 완료 표시가 제공됩니다.',tags:'진도 기록 학습 완료 개인정보'},
