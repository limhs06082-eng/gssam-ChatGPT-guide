...
const names = {choose:'도구 선택',setup:'시작 준비',prompt:'요청과 후속 질문',privacy:'자료와 개인정보',chat:'ChatGPT 채팅',files:'파일 질문',search:'검색과 출처',projects:'프로젝트 활용',work:'ChatGPT Work',codex:'Codex'};
...
const keys = [...foundationKeys,'chat',...chatPracticeKeys,'work','codex'];
const publishedByGroup = {start:foundationKeys,chat:{0:'chat',3:'files',5:'search',6:'projects'},work:{0:'work'},codex:{0:'codex'}};
...
const faqItems = [
 ...
 {id:'progress',group:'이 가이드 이용하기',question:'완료 표시와 이어보기는 어디에 저장되나요?',answer:'이 가이드를 여는 현재 브라우저에 저장됩니다. 회원가입이나 서버 전송은 없습니다. 다른 기기·브라우저에서는 이어지지 않으며, 브라우저 데이터를 지우면 초기화될 수 있습니다. 공통 입문 4편, 대표 실습 3편과 채팅 실전 3편, 총 10편에 완료 표시가 제공됩니다.',tags:'진도 기록 학습 완료 개인정보'},
 {id:'planned',group:'이 가이드 이용하기',question:'학습 지도에 준비 예정이라고 표시돼요.',answer:'지금은 공통 입문 4편, 세 경로의 대표 실습 3편과 채팅 실전 3편을 공개한 버전입니다. 학습 지도에는 앞으로 확장할 목차도 함께 표시했습니다. ‘학습하기’ 또는 ‘실습하기’가 붙은 페이지를 이용해 주세요.',tags:'페이지 준비 개발 목차'}
];
const courses = [
