...
const keys = [...foundationKeys,'chat',...chatPracticeKeys,'work',...workPracticeKeys,'codex','workspace','folders','plan','run','modify','debug','changes','backup','publish'];
const publishedByGroup = {start:foundationKeys,chat:{0:'chat',3:'files',5:'search',6:'projects'},work:{0:'work',3:'compare',4:'documents',6:'review'},codex:{0:'codex',1:'workspace',2:'folders',3:'plan',4:'run',5:'modify',6:'debug',7:'changes',8:'backup',9:'publish'}};
...
const faqItems = [
 ...
 {id:'progress',group:'이 가이드 이용하기',question:'완료 표시와 이어보기는 어디에 저장되나요?',answer:'이 가이드를 여는 현재 브라우저에 저장됩니다. 회원가입이나 서버 전송은 없습니다. 다른 기기·브라우저에서는 이어지지 않으며, 브라우저 데이터를 지우면 초기화될 수 있습니다. 공통 입문 4편, 대표 실습 3편, 채팅·Work·Codex 실전 각 3편, Codex 준비·수정복원 각 3편을 더해 총 22편에 완료 표시가 제공됩니다.',tags:'진도 기록 학습 완료 개인정보'},
